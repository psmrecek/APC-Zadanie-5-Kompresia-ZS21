...
/// <summary>
/// Main function of program. Function reads the fil and calls the processing function. 
/// </summary>
...
{
	//int argc = 4;
	//const char* argv[] = { "file", "compress", "test1.txt", "out1.txt" };
	//const char* argv[] = { "file", "decompress", "test2.txt", "out2.txt" };
